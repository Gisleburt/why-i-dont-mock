...
pub fn StubAdaptors(cx: Scope) -> Element {
    cx.render(rsx!(
        ...
        Notes {
            ...
            p {"What we had an adaptor that matched the port but encapsulated all of the behaviour"}
...
pub fn StubAdaptorExample(cx: Scope) -> Element {
    cx.render(rsx!(
        ...
        Notes {
            ...
            p {"For a production app, this would be terrible, but for testing, this is very useful"}
