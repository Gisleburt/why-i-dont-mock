...
pub fn DddIsAwesome(cx: Scope) -> Element {
    cx.render(rsx!(
        ...
        Notes {
            ...
            p { indoc! { "
                DDD obviously encompasses many things but I want to talk about one specific thing
            " } }
        }
    ))
}
...
pub fn HexagonalArchitecture(cx: Scope) -> Element {
    cx.render(rsx!(
        ...
        Notes {
            ...
            " } }
            p { indoc! { "
                Instead, think about it as a loose description of how we talk to external systems
            " } }
            p { indoc! { "
